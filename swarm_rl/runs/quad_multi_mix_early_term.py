...
_params = ParamGrid([
    ...
    ('quads_early_termination', [True, False]),
...
_experiment = Experiment(
    'quad_mix_baseline-8_mixed_earlyterm',
    QUAD_BASELINE_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('paper_quads_multi_mix_baseline_8a_deepsets_earlyterm_v116', experiments=[_experiment])
